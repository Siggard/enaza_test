...
1. Наличие тестов;
2. Использование composer, сторонних библиотек и фреймворков;
3. Использование механизма мультипоточности/мультипроцессинга;
4. Запуск приложения в виде веб-сервиса с поддержкой REST. Возможность запрашивать текущее состояние бара. Ограничение доступа, авторизация;
5. Настроенный Docker образ.
```